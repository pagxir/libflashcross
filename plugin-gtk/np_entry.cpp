...
{
  printf("plugin function init pFuncs is NULL!\n");
  if(pFuncs == NULL)
    return NPERR_INVALID_FUNCTABLE_ERROR;

  printf("plugin function init call is version bad!\n");
  if(HIBYTE(pFuncs->version) > NP_VERSION_MAJOR)
    return NPERR_INCOMPATIBLE_VERSION_ERROR;

  if(pFuncs->size < sizeof(NPNetscapeFuncs)) {
    printf("plugin init call is %d %d!\n",
  ...
  *(void**)&pluginFuncs->event	    = (void*)defProc;
  ...
  NPP_Initialize();
#endif
  printf("plugin function init call is finish!\n");
